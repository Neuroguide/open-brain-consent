...
Dane i próbki  pochodzące z tego badania mogą być użyte do innych projektów badawczych w przyszłości poza badaniem, w którym Państwo aktualnie uczestniczą. Te przyszłe projekty mogą dotyczyć innych zagadnień i nie muszą być związane z celem aktualnego badania. W ramach projektu udostępnimy niektóre dane, w tym dane obrazowe, w domenie publicznej w postaci bazy danych dostępnej w internecie. Dane udostępniane publicznie będą obejmować jedynie <wyjaśnić co będzie udostępniane publicznie>. Ponadto całość danych zebranych w ramach projektu będzie dostępna dla innych badaczy poprzez kontrolowany dostęp do bazy danych. W celi zminimalizowania ryzyka dla Państwa prywatności zespół ekspertów będzie szczegółowo zapoznawał się z każdym zapytaniem o dostęp do danych ze strony innych naukowców przed udostępnieniem im możliwości korzystania z bazy danych, po upewnieniu się, że strona wnioskująca też jest w stanie chronić Państwa dane. Inni badacze mogą pochodzić z <instytucja prowadząca badanie> lub z innych ośrodków badawczych zarówno komercyjnych jak i akademickich na całym świecie.
